...
return array(
    'messages' => array(
        ...
        'GitHub' => 'GitHub',
        'Happy with this plugin? Rate it on WordPress.org or star it on GitHub.' => 'このプラグインに満足していますか ? WordPress.org で評価するか、GitHub でスターを付けてください。',
        'Is DIESIS JWT Auth doing its job? A short review on WordPress.org and a star on GitHub help other site owners find it.' => 'DIESIS JWT Auth は役割を果たしていますか ? WordPress.org での短いレビューと GitHub でのスターが、他のサイト運営者がこのプラグインを見つける助けになります。',
        'Issuer' => 'Issuer',
