...
return array(
    'messages' => array(
        ...
        'GitHub' => 'GitHub',
        'Happy with this plugin? Rate it on WordPress.org or star it on GitHub.' => '对这个插件满意吗？欢迎在 WordPress.org 上评价，或在 GitHub 上点个星标。',
        'Is DIESIS JWT Auth doing its job? A short review on WordPress.org and a star on GitHub help other site owners find it.' => 'DIESIS JWT Auth 发挥作用了吗？在 WordPress.org 上写一段简短评价、在 GitHub 上点个星标，可以帮助其他站点管理者发现它。',
        'Issuer' => 'Issuer',
